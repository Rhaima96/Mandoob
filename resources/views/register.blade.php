...
<div class="container">
    <div class="row">
        <div class="col" style="padding-top: 1rem;"><a class="text-decoration-none" href="/"
...
<div class="container d-md-flex d-xl-flex align-items-md-center align-items-xl-center" style="height: 700px;">
    <div class="row">
        <div class="col-sm-12 col-md-8 mb-5">
            <h1 style="font-family: 'Ink Free';font-weight: bold;">Add a phone number</h1>
            <p style="font-family: Roboto, sans-serif;">Enter your phone number that you would like
                <br>to&nbsp;associate to your account.&nbsp;</p>
            <form method="" action="/verify ">
                @csrf
                <div class="form-row mb-4">
                    ...
                    <div class="col-8"><input class="form-control" type="tel" onkeypress='return event.charCode >= 48 && event.charCode <= 57' name="phone" placeholder="Phone number"
                            autofocus=""></div>
                </div><button class="btn btn-primary" type="submit"
                    style="background: #4AB690;font-family: Conv_Rockwell;font-size: 1.3rem;">Register</button><button
